...
def move_forward(vis):
    d_name = path_out + "depth/" + base_name[index] + "_depth.png"
...
for a in tqdm(range(len(allObjNames))):
    ...
    vis
    vis.create_window(width=4096,height=4096,visible=False)#Max depth resolution is 1080, for some reason won't render properly for any higher
